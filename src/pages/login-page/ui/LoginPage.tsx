...
export const LoginPage = () => {
  const { login, token, error, isLoading } = useAuth()
  ...
  useEffect(() => {
    ...
    if (tokenLocal) setRemember(true)
  }, [])
        ...
        <div className={s.card__content}>
          ...
          <form className={s.form} onSubmit={handleSubmit}>
            <div className={s.inputGroup}>
              ...
              <div className={`${s.input} ${fieldError.username ? s.inputError : ""}`}>
            ...
            <div className={s.inputGroup}>
              ...
              <div className={`${s.input} ${fieldError.password ? s.inputError : ""}`}>
            ...
            <div className={s.checkboxRow} onClick={() => setRemember(!remember)}>
              <img
                src={remember ? checkboxChecked : checkbox}
                alt="checkbox"
